...
async function getLeaderboard(store) {
    try {
        ...
        const data = await store.get('casino-leaderboard');
...
async function saveLeaderboard(store, scores) {
    try {
        ...
        await store.set('casino-leaderboard', safeData);
...
exports.handler = async function(event, context) {
    console.log('Casino leaderboard function invoked with method:', event.httpMethod);
